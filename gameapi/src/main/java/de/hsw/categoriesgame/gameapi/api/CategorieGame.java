...
public interface CategorieGame {
    ...
    /**
     * List of players joins a specified lobby.
     * @param lobbyCode string that is specified when creating a lobby
     * @param players   list of players that have to be initialized beforehand
     * @return          object of class Lobby that the user joined
     * @throws LobbyNotFoundException if lobby is not found (e.g. not valid lobbyCode)
     */
    Lobby joinLobby(String lobbyCode, final List<Player> players) throws LobbyNotFoundException;
     ...
     * @param players   list of players
     */
    void leaveLobby(Lobby lobby, List<Player> players);
}
